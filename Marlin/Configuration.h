...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 93.68
  #define DEFAULT_bedKi 16.97
  #define DEFAULT_bedKd 344.75
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define PROBE_Y_FIRST
    ...
    //
    #define ABL_BILINEAR_SUBDIVISION  // Original Ender3S1 Configs set this to Enable, Re-enabled by BakeJake.
